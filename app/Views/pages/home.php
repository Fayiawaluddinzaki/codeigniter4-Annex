...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        ...
                                        <div class="col-sm-10 mx-auto text-white text-center">
                                            <p>Lorem Ipsum is simply dummy text of the <span
                                                    class="warning">#TWITTER</span> and typesetting industry. A
            ...
            <div class="col-md-12 col-lg-12 col-xl-4">
                <div class="card bg-white m-b-30">
                    <img src="<?= base_url()?>/template/assets/images/widgets/wather.jpg" alt="" class="img-fluid">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-2.jpg"
                                                alt="user" width="40"> </td>
                                        <td>
                                            <a href="javascript:void(0);">Ruby T. Curd</a>
                                        </td>
                                        <td>
                                            <img src="<?= base_url()?>/template/assets/images/flags/us_flag.jpg" alt=""
                                                style="width:30px">
                                        </td>
                                        <td>$100</td>
                                        <td>10</td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-3.jpg"
                                                alt="user" width="40"> </td>
                                        <td>
                                            <a href="javascript:void(0);">William A. Johnson</a>
                                        </td>
                                        <td>
                                            <img src="<?= base_url()?>/template/assets/images/flags/french_flag.jpg"
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-4.jpg"
                                                alt="user" width="40"> </td>
                                        <td>
                                            <a href="javascript:void(0);">Bobby M. Gray</a>
                                        </td>
                                        <td>
                                            <img src="<?= base_url()?>/template/assets/images/flags/spain_flag.jpg"
                                                alt="" style="width:30px">
                                        </td>
                                        <td>$380</td>
                                        <td>19</td>
                                        ...
                                        <td>
                                            <div class="progress" style="height:8px;">
                                                <div class="progress-bar bg-dark" role="progressbar" aria-valuenow="65"
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-5.jpg"
                                                alt="user" width="40"> </td>
                                        <td>
                                            <a href="javascript:void(0);">Robert N. Carlile</a>
                                        </td>
                                        <td>
                                            <img src="<?= base_url()?>/template/assets/images/flags/russia_flag.jpg"
                                                alt="" style="width:30px">
                                        </td>
                                        <td>$450</td>
                                        <td>30</td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-6.jpg"
                                                alt="user" width="40"> </td>
                                        <td>
                                            <a href="javascript:void(0);">Ruby T. Curd</a>
                                        </td>
                                        <td>
                                            <img src="<?= base_url()?>/template/assets/images/flags/italy_flag.jpg"
                                                alt="" style="width:30px">
                                        </td>
                                        <td>$500</td>
                                        <td>40</td>
                                        ...
                                        <td>
                                            <div class="progress" style="height:8px;">
                                                <div class="progress-bar l-blue" role="progressbar" aria-valuenow="17"
                            ...
                            <li class="p-3">
                                <div class="media">
                                    <div class="thumb float-left">
                                        <a href="#">
                                            <img class=" rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-5.jpg" alt="">
                                        </a>
                                    </div>
                            ...
                            <li class="p-3">
                                <div class="media">
                                    <div class="thumb float-left">
                                        <a href="#">
                                            <img class=" rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-4.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="media-body">
                            ...
                            <li class="p-3">
                                <div class="media">
                                    <div class="thumb float-left">
                                        <a href="#">
                                            <img class=" rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-3.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <p class="media-heading mb-0">Robert N. Carlile<i
                                                class="fa fa-circle text-danger mr-1 pull-right"></i></p>
                            ...
                            <li class="p-3">
                                <div class="media">
                                    <div class="thumb float-left">
                                        <a href="#">
                                            <img class=" rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="media-body">
                            ...
                            <li class="p-3">
                                <div class="media">
                                    <div class="thumb float-left">
                                        <a href="#">
                                            <img class=" rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-1.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <p class="media-heading mb-0">Ruby T. Curd <i
                            ...
                            <li class="p-3">
                                <div class="media">
                                    <div class="thumb float-left">
                                        <a href="#">
                                            <img class=" rounded-circle"
                                                src="<?= base_url()?>/template/assets/images/users/avatar-6.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <p class="media-heading mb-0">Robert N. Carlile <i
